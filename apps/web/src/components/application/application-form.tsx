...
export function ApplicationForm({ administrativeData }: { administrativeData: AdministrativeData }) {
  ...
  const next = async () => { await form.handleSubmit(); draft.setStep(Math.min(current + 1, steps.length - 1)); };
