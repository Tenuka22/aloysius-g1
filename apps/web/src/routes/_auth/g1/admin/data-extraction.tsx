...
const scoringFields62: FieldGroup = {
  ...
  fields: [
    ...
    { field: "scoringInputs.carnivalContribution", type: "number", source: "form", description: "Times contributed to school carnivals (0.5 marks each)" },
    { field: "scoringInputs.shramadanaContribution", type: "number", source: "form", description: "Times participated in Shramadana campaigns (0.5 marks each); carnival + shramadana + other combined, max 2" },
    { field: "scoringInputs.otherContributionEntries", type: "array<{count?, description?}>", source: "form", description: "Up to 4 free-text other school contributions (0.5 marks per occasion each, same combined cap as carnival/shramadana)" },
