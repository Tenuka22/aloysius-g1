  ...
  const sidebarNav = <>
    ...
    <SidebarContent>
      <SidebarGroup>
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin")} isActive={location.pathname === "/admin"} onClick={() => setSidebarOpen(false)}><LayoutDashboard size={20} /> {t("admin.sidebar.overview")}</SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin/applications")} isActive={location.pathname.startsWith("/admin/applications")} onClick={() => setSidebarOpen(false)}><BarChart3 size={20} /> {t("admin.sidebar.applications")}</SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin/admissions")} isActive={location.pathname.startsWith("/admin/admissions")} onClick={() => setSidebarOpen(false)}><ClipboardCheck size={20} /> {t("admin.sidebar.admissions")}</SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin/schools")} isActive={location.pathname === "/admin/schools"} onClick={() => setSidebarOpen(false)}><MapPinned size={20} /> {t("admin.sidebar.schoolsHub")}</SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin/admin_map")} isActive={location.pathname === "/admin/admin_map"} onClick={() => setSidebarOpen(false)}><MapPin size={20} /> {t("admin.sidebar.mapView")}</SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin/mark-allocation")} isActive={location.pathname === "/admin/mark-allocation"} onClick={() => setSidebarOpen(false)}><ListOrdered size={20} /> {t("admin.sidebar.markAllocation")}</SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin/data-extraction")} isActive={location.pathname === "/admin/data-extraction"} onClick={() => setSidebarOpen(false)}><Database size={20} /> {t("admin.sidebar.dataExtraction")}</SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin/requests")} isActive={location.pathname === "/admin/requests"} onClick={() => setSidebarOpen(false)}><FileWarning size={20} /> {t("admin.sidebar.submissionRequests")}</SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin/removal-requests")} isActive={location.pathname === "/admin/removal-requests"} onClick={() => setSidebarOpen(false)}><Trash2 size={20} /> {t("admin.sidebar.removalRequests")}</SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton href={adminHref("/admin/forgot-requests")} isActive={location.pathname === "/admin/forgot-requests"} onClick={() => setSidebarOpen(false)}><KeyRound size={20} /> {t("admin.sidebar.forgotKeyRequests")}</SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarGroup>
    </SidebarContent>
            ...
            <Card className="mb-4">
              ...
              <CardContent>
                ...
                <div className="flex gap-2 flex-wrap">
                  <Button variant="secondary" render={<Link to="/admin/requests" search={true} />}>{t("admin.overview.appRequests.submissionRequests")}</Button>
                  <Button variant="secondary" render={<Link to="/admin/removal-requests" search={true} />}>{t("admin.overview.appRequests.removalRequests")}</Button>
                  <Button variant="secondary" render={<Link to="/admin/forgot-requests" search={true} />}>{t("admin.overview.appRequests.forgotKeyRequests")}</Button>
                </div>
              </CardContent>
            </Card>
            <Card className="mb-4">
              ...
              <CardContent>
                ...
                <Button variant="secondary" render={<Link to="/admin/admissions" search={true} />}><ClipboardCheck size={17} /> {t("admin.overview.admissions.openAdmissions")}</Button>
              </CardContent>
            </Card>
            <Card className="mb-4">
              ...
              <CardContent>
                ...
                <Button variant="secondary" render={<Link to="/admin/schools" search={true} />}><MapPinned size={17} /> {t("admin.overview.schoolCoords.openHub")}</Button>
              </CardContent>
            </Card>
            <Card className="mb-4">
