...
import { g1Applications, g1ApplicationMarks } from "./schema/g1-logic";
...
for (const app of seedApps) {
 ...
 await db.insert(g1ApplicationMarks).values({
 id: randomUUID(),
